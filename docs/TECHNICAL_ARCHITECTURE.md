...
Estado de referencia: rama `main`, commit `045dd1f`, auditado el 21 de agosto de 2026.
...
|---|---|---|
| `index.html` | Semántica, navbar, filtros, contenedores, carrusel, footer y `dialog` | Carga CSS y JS con parámetros de caché |
